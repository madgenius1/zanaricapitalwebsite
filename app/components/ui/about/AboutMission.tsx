      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="sticky top-10">
            ...
            {/* Simple Metric Row */}
            <div className="mt-10 grid grid-cols-2 gap-4 border-t border-zinc-100 pt-10 dark:border-zinc-800">
              <div>
                <p className="text-2xl font-bold text-zinc-900 dark:text-white">100%</p>
                <p className="text-sm text-zinc-500">Kenyan Owned</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-zinc-900 dark:text-white">Direct</p>
                <p className="text-sm text-zinc-500">Asset Access</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-12 overflow-hidden rounded-2xl bg-zinc-100 dark:bg-zinc-900">
              <Image
                src="/community.webp"
                alt="Community"
                width={800}
            ...
            <div className="col-span-7 overflow-hidden rounded-2xl bg-zinc-100 dark:bg-zinc-900">
              <Image
                src="/hand.webp"
                alt="Trust"
                width={400}
